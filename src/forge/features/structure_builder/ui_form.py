...
class Ui_view_form:
    def setupUi(self, view_form):
        ...
        self.action_duplicate_row.setObjectName("action_duplicate_row")
        self.action_duplicate_structure = QAction(view_form)
        self.action_duplicate_structure.setObjectName("action_duplicate_structure")
        self.action_scan_child = QAction(view_form)
        self.action_scan_child.setObjectName("action_scan_child")
        self.action_create_child_types = QAction(view_form)
        self.action_create_child_types.setObjectName("action_create_child_types")
        self.action_create_subtree_types = QAction(view_form)
        self.action_create_subtree_types.setObjectName("action_create_subtree_types")
        ...
        self.tree_structures.setObjectName("tree_structures")
        ...
        self.btn_duplicate_structure.setObjectName("btn_duplicate_structure")
        ...
        self.frm_right_main.setObjectName("frm_right_main")
        ...
        self.frm_right_header.setObjectName("frm_right_header")
        ...
        self.btn_duplicate_row.setObjectName("btn_duplicate_row")
        ...
        self.verticalLayout_inspector.setObjectName("verticalLayout_inspector")
        self.lbl_inspector_title = QLabel(self.frm_inspector)
        self.lbl_inspector_title.setObjectName("lbl_inspector_title")

        self.verticalLayout_inspector.addWidget(self.lbl_inspector_title)

        self.lbl_provenance = QLabel(self.frm_inspector)
        self.lbl_provenance.setObjectName("lbl_provenance")
        ...
        self.lbl_root_info.setObjectName("lbl_root_info")
        ...
        self.lbl_parent_links.setObjectName("lbl_parent_links")
        ...
        self.lbl_child_links.setObjectName("lbl_child_links")
        ...
        self.lbl_selected_member_info.setObjectName("lbl_selected_member_info")
        ...
        self.lbl_type_status.setObjectName("lbl_type_status")
        ...
        self.btn_create_subtree_types.setObjectName("btn_create_subtree_types")
    ...
    def retranslateUi(self, view_form):
        view_form.setWindowTitle(QCoreApplication.translate("view_form", "Structure Builder", None))
        self.action_enable.setText(QCoreApplication.translate("view_form", "Enable Row", None))
#if QT_CONFIG(shortcut)
        self.action_enable.setShortcut(QCoreApplication.translate("view_form", "E", None))
#endif // QT_CONFIG(shortcut)
        self.action_disable.setText(QCoreApplication.translate("view_form", "Disable Row", None))
#if QT_CONFIG(shortcut)
        self.action_disable.setShortcut(QCoreApplication.translate("view_form", "D", None))
#endif // QT_CONFIG(shortcut)
        self.action_resolve.setText(QCoreApplication.translate("view_form", "Auto Resolve", None))
#if QT_CONFIG(shortcut)
        self.action_resolve.setShortcut(QCoreApplication.translate("view_form", "R", None))
#endif // QT_CONFIG(shortcut)
        self.action_finalize.setText(QCoreApplication.translate("view_form", "Finalize", None))
#if QT_CONFIG(shortcut)
        self.action_finalize.setShortcut(QCoreApplication.translate("view_form", "F", None))
#endif // QT_CONFIG(shortcut)
        self.action_edit.setText(QCoreApplication.translate("view_form", "Edit Row", None))
#if QT_CONFIG(shortcut)
        self.action_edit.setShortcut(QCoreApplication.translate("view_form", "Ctrl+E", None))
#endif // QT_CONFIG(shortcut)
        self.action_add_row.setText(QCoreApplication.translate("view_form", "Add Row", None))
#if QT_CONFIG(shortcut)
        self.action_add_row.setShortcut(QCoreApplication.translate("view_form", "Insert", None))
#endif // QT_CONFIG(shortcut)
        self.action_duplicate_row.setText(QCoreApplication.translate("view_form", "Duplicate Row", None))
#if QT_CONFIG(shortcut)
        self.action_duplicate_row.setShortcut(QCoreApplication.translate("view_form", "Ctrl+D", None))
#endif // QT_CONFIG(shortcut)
        self.action_duplicate_structure.setText(QCoreApplication.translate("view_form", "Duplicate Structure", None))
#if QT_CONFIG(shortcut)
        self.action_duplicate_structure.setShortcut(QCoreApplication.translate("view_form", "Ctrl+Shift+D", None))
#endif // QT_CONFIG(shortcut)
        self.action_scan_child.setText(QCoreApplication.translate("view_form", "Scan Child Structure", None))
#if QT_CONFIG(shortcut)
        self.action_scan_child.setShortcut(QCoreApplication.translate("view_form", "Ctrl+Shift+C", None))
#endif // QT_CONFIG(shortcut)
        self.action_create_child_types.setText(QCoreApplication.translate("view_form", "Create Child Types", None))
        self.action_create_subtree_types.setText(QCoreApplication.translate("view_form", "Create Type Subtree", None))
        self.lbl_title.setText(QCoreApplication.translate("view_form", "Structures & Scan Graph", None))
        self.input_filter.setPlaceholderText(QCoreApplication.translate("view_form", "Filter structures...", None))
        self.btn_add.setText(QCoreApplication.translate("view_form", "Add Structure", None))
        self.btn_duplicate_structure.setText(QCoreApplication.translate("view_form", "Duplicate Structure", None))
        self.btn_remove.setText(QCoreApplication.translate("view_form", "Remove Structure", None))
        self.lbl_name.setText(QCoreApplication.translate("view_form", "Name:", None))
        self.btn_apply_name.setText(QCoreApplication.translate("view_form", "Apply Name", None))
        ___qtablewidgetitem = self.tbl_structure.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("view_form", "Offset", None))
        ___qtablewidgetitem1 = self.tbl_structure.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("view_form", "Type", None))
        ___qtablewidgetitem2 = self.tbl_structure.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("view_form", "Name", None))
        ___qtablewidgetitem3 = self.tbl_structure.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("view_form", "Score", None))
        ___qtablewidgetitem4 = self.tbl_structure.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("view_form", "Comment", None))
        self.btn_auto_resolve.setText(QCoreApplication.translate("view_form", "Auto Resolve", None))
        self.btn_create_type.setText(QCoreApplication.translate("view_form", "Create Type", None))
        self.btn_enable_rows.setText(QCoreApplication.translate("view_form", "Enable", None))
        self.btn_remove_rows.setText(QCoreApplication.translate("view_form", "Remove", None))
        self.btn_view_scanned_uses.setText(QCoreApplication.translate("view_form", "View Scanned Uses", None))
        self.btn_edit_row.setText(QCoreApplication.translate("view_form", "Edit Row", None))
        self.btn_set_origin.setText(QCoreApplication.translate("view_form", "Set Origin", None))
        self.btn_toggle_array.setText(QCoreApplication.translate("view_form", "Array", None))
        self.btn_disable_rows.setText(QCoreApplication.translate("view_form", "Disable", None))
        self.btn_clear_rows.setText(QCoreApplication.translate("view_form", "Clear", None))
        self.btn_add_row.setText(QCoreApplication.translate("view_form", "Add Row", None))
        self.btn_recognize_vtable.setText(QCoreApplication.translate("view_form", "Recognize VTable", None))
        self.btn_duplicate_row.setText(QCoreApplication.translate("view_form", "Duplicate Row", None))
        self.lbl_summary.setText(QCoreApplication.translate("view_form", "No structure selected.", None))
        self.lbl_inspector_title.setText(QCoreApplication.translate("view_form", "Inspector", None))
        self.lbl_provenance.setText(QCoreApplication.translate("view_form", "Provenance: -", None))
        self.lbl_root_info.setText(QCoreApplication.translate("view_form", "Root: -", None))
        self.lbl_parent_links.setText(QCoreApplication.translate("view_form", "Parents: -", None))
        self.lbl_child_links.setText(QCoreApplication.translate("view_form", "Children: -", None))
        self.lbl_selected_member_info.setText(QCoreApplication.translate("view_form", "Selected Row: -", None))
        self.lbl_type_status.setText(QCoreApplication.translate("view_form", "Type Status: not created", None))
        self.btn_scan_child.setText(QCoreApplication.translate("view_form", "Scan Child Structure", None))
        self.btn_open_child.setText(QCoreApplication.translate("view_form", "Open Linked Child", None))
        self.btn_create_child_types.setText(QCoreApplication.translate("view_form", "Create Child Types", None))
        self.btn_create_subtree_types.setText(QCoreApplication.translate("view_form", "Create Type Subtree", None))
    # retranslateUi
